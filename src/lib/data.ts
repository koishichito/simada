...
export const clinics: Clinic[] = [
  {
    ...
    website: "https://example.com/toshin-gi",
  },
  {
    id: "c2",
    name: "横浜整形外科病院",
...
export const doctors: Doctor[] = [
  ...
  },
  {
    ...
    matchCautions: [
      "年収希望2,200万円以上（求人上限2,400万円で交渉余地あり）",
      "開始が7月と遅め",
  ...
  },
  {
    ...
    desiredSalary: "年収1,500万円以上",
    ngConditions: ["当直あり", "美容のみ"],
...
export const positions: Position[] = [
  ...
  },
  {
    ...
    salary: "常勤：年収2,000〜2,400万円 / 非常勤：日給12万円",
  ...
  },
  {
    ...
    employmentType: "常勤・非常勤",
    workSchedule: "常勤：月〜土（半日×1） 9:00-18:00 / 非常勤：週1〜3日",
    salary: "常勤：年収1,500〜1,800万円 / 非常勤：日給8万円〜",
...
export const pipelineCandidates: PipelineCandidate[] = [
  {
    ...
    activityLog: [
      { date: "2026-02-20", action: "候補としてリストアップ", actor: "system", detail: "AIマッチングスコア95で自動抽出" },
  ...
  },
  {
    ...
    activityLog: [
      { date: "2026-02-28", action: "候補としてリストアップ", actor: "system", detail: "AIマッチングスコア82で自動抽出" },
  ...
  },
  {
    ...
    activityLog: [
      { date: "2026-03-06", action: "候補としてリストアップ", actor: "system", detail: "AIマッチングスコア78で自動抽出" },
  ...
  },
  {
    ...
    activityLog: [
      { date: "2026-03-09", action: "候補としてリストアップ", actor: "system", detail: "AIマッチングスコア70で自動抽出。ESD未経験だが育成枠として候補に" },
    ],
  },
  {
    id: "pc5",
    ...
    activityLog: [
      ...
      { date: "2026-03-05", action: "条件提示", actor: "clinic", detail: "日給10万円、火・木勤務、4/15開始" },
...
export const notifications: Notification[] = [
  ...
  },
  {
    ...
    type: "interest",
    title: "関心表明を受領",
    body: "Dr. E（匿名）が千葉中央内科クリニックの案件に関心を表明しました",
  ...
  },
  {
    ...
    type: "interview",
    title: "面談完了",
    body: "Dr. F × 千葉中央内科クリニックの面談が完了しました。結果確認をお願いします。",
  ...
  },
  {
    ...
    type: "message",
    title: "医院からのメッセージ",
    body: "都心消化器クリニック院長から条件提示書の修正依頼が届きました",
  ...
  },
  {
    ...
    type: "match",
    title: "新規案件",
    body: "湘南リハビリテーション病院から新規案件「整形外科医（非常勤）」が掲載されました",
...
export const stageColors: Record<PipelineCandidate["stage"], string> = {
